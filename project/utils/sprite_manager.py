...
class SpriteManager:
    ...
    def load_image(__filename__):
        file_path = os.path.join(constants.ASSETS_DIR, 'sprites', __filename__)
    ...
    '''
    Gets the sequence of frames from a sprite sheet
    ...
    def get_frame_sequence(img_url, frame_width, frame_height, scale):
        ...
        for i in range(0, frame_amount):
            frames.append(
                SpriteManager.get_frame(
                    img, frame_width, frame_height, scale, i))
